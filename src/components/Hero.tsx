...
const Hero = () => {
  return <div className="relative overflow-hidden pb-16 pt-16 md:pb-24 md:pt-20 lg:pb-32 lg:pt-24">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/2 top-0 -z-10 -translate-x-1/2 opacity-30 blur-3xl">
          <div className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-mcp-blue to-mcp-purple" style={{
